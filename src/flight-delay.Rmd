...
```{r}
library("sampling")
# Per questió de memòria del PC reduim el nombre de registres,amb el metode srswor.
n = 50000
N=nrow(flights)
s=srswor(n, N)

flights = flights[which(s == 1),]
colSums(is.na(flights))

# kNN on ARRIVAL_DELAY
suppressWarnings(suppressMessages(library(VIM)))
flights$ARRIVAL_DELAY = kNN(flights)$ARRIVAL_DELAY
flights$LATE_AIRCRAFT_DELAY = kNN(flights)$LATE_AIRCRAFT_DELAY
...
boxplot(flights$LATE_AIRCRAFT_DELAY, main="Late aircraft delay")
```
